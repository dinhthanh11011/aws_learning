...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'first-exam', title: 'Full Paper', description: 'Sat a complete 65-question timed exam.', hint: 'Complete a full exam simulation.', icon: '📝' },
  { id: 'passing-grade', title: 'Above the Line', description: 'Scored 720 or better on a full paper.', hint: 'Pass a full exam simulation.', icon: '✅' },
