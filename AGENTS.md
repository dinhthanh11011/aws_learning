...
| Lessons | 22 (reachability + identity + storage + resilience + serverless + data and cost + the developer cluster), 416 sections, 91 checks | 9 (the serverless three, partition keys, caching, and the developer four) |
